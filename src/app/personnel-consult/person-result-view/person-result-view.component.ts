...
export class PersonResultViewComponent implements OnInit, OnDestroy, OnChanges {
  ...
  updateFilteredData(): void {
    ...
    this.filteredData.sort((a, b) => new Date(b.Fecha).getTime() - new Date(a.Fecha).getTime());
    ...
    this.dataStorageService.updateTotalHours(this.totalHoursWorked); 
  }
